...
BLOG_AUTHOR = "colobas"  # (translatable)
BLOG_TITLE = "Guilherme Grijó Pires"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://colobas.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://colobas.github.io/"
BLOG_EMAIL = "mail@gpir.es"
BLOG_DESCRIPTION = "ML Engineer / Wannabe World-Changer"  # (translatable)
